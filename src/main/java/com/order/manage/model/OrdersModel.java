...
public class OrdersModel {
	...
	public OrdersModel(int orderId, @NotBlank(message = "order description shoud be not null") String description,
			double orderTotalAmount, int totalItems, List<OrderItemModel> orderItemModelList,
			PaymentStatusModel paymentStatusModel, ShipmentStatusModel shipementStatusModel,
